...
$string['block/testblock:myaddinstance']  = 'Add a new Testblock to Dashboard';
$string['pluginname'] = 'Moodle Test block';
$string['complete'] = 'Completed';
$string['format'] = 'd%-M%-Y%';
$string['privacy:metadata'] = 'This block show activity name with thier completion status';
